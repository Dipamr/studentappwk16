...
public class StudentCURDTest extends TestBase {
    static String firstName = "rupa"+ TestUtils.getRandomValue();
    static String lastName = "panchal"+ TestUtils.getRandomValue();
    static String email = "rup"+ TestUtils.getRandomValue()+ "@gmail.com";
